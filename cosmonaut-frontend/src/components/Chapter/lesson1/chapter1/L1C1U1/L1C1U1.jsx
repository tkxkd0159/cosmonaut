          ...
          <div class="lg:w-1/2 w-full md:w-2/3">
            ...
            <ContentDesc>
              ...
              <BasicP>
                ...
                <CodeBlock>recipient</CodeBlock>. It assumes only address
          ...
          <div class="lg:w-1/2 w-full md:w-2/3">
            ...
            <ContentDesc>
              ...
              <BasicP>
                ...
                contract's action. <CodeBlock>Contract</CodeBlock> must be a
                smart contract and must comply with the CW721 Receiver
        ...
        <div class="mx-auto flex flex-wrap justify-center border-dashed border-gray-200 border-b-2 py-16 bg-gray-700 px-8 md:px-4">
          ...
          <div class="lg:w-1/2 w-full md:w-2/3">
            ...
            <ContentDesc>
              <Markdown code={code4} />
              <BasicP>
                Revokes previously approved <CodeBlock>token_id</CodeBlock>{" "}
                token.
              </BasicP>
              <BasicP>
                It can only be done if the <CodeBlock>env.sender</CodeBlock>
        ...
        <div class="mx-auto flex flex-wrap justify-center border-dashed border-gray-200 border-b-2 py-16 bg-gray-700 px-8 md:px-4">
          ...
          <div class="lg:w-1/2 w-full md:w-2/3">
            ...
            <ContentDesc>
              <Markdown code={code5} />
              <BasicP>
                Allows <CodeBlock>operator</CodeBlock> to transfer or send all
                tokens held by
